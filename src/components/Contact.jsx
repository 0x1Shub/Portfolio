  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      ...
      'template_86jmqvw', 
      {
        ...
        to_email: 'shubhamyeram13@gmail.com',
      ...
      <motion.div variants={slideIn('left', 'tween', 0.2, 1)} className='flex-[0.75] bg-black-100 p-8 rounded-2xl'>
        ...
        <form ref={formRef} onSubmit={handleSubmit} className='mt-12 flex flex-col gap-8'>
          ...
          <label className='flex flex-col'>
            ...
            <textarea rows={'7'} name='message' value={form.message} onChange={handleChange} placeholder={"What's you want to say?"} className='bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium' />
          </label>
